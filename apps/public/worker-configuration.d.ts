/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 61c0adfeb2df22ade7c158a078cde16f)
...
interface __BaseEnv_Env {
	...
	SELF_HOSTED: "false";
	API: Fetcher /* vibecms-prod */ | Fetcher /* vibecms-api-dev */;
	OG: Service /* entrypoint OgWorker from vibecms-og-prod */ | Service /* entrypoint OgWorker from vibecms-og-dev */;
}
declare namespace Cloudflare {
	interface ProductionEnv {
		...
		SELF_HOSTED: "false";
		API: Fetcher /* vibecms-prod */;
		OG: Service /* entrypoint OgWorker from vibecms-og-prod */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_URL" | "PUBLIC_BLOG_DOMAIN" | "SELF_HOSTED">> {}
}
