...
import { getPublishedPost as getPublishedPostData, listPublishedPosts as listPublishedPostsData, listPublishedPostsByTag as listPublishedPostsByTagData, searchPublishedPosts as searchPublishedPostsData } from "./public-blog-data";

const getPublishedPost = (siteId: string, slug: string) => getPublishedPostData(env.DB, siteId, slug);
const listPublishedPosts = (siteId: string) => listPublishedPostsData(env.DB, siteId);
const listPublishedPostsByTag = (siteId: string, tag: string) => listPublishedPostsByTagData(env.DB, siteId, tag);
const searchPublishedPosts = (siteId: string, query: string) => searchPublishedPostsData(env.DB, siteId, query);
