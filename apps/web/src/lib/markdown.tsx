 ...
 * Returns "#" for anything that is not http(s), mailto, or a relative/anchor
 * link. React escapes attribute values, so the raw URL (including `&` in query
 * strings) is passed through unchanged.
 */
 ...
 * Supports: headings (h1-h3), paragraphs, bold, italic, inline code, fenced
 * code blocks, links, ordered/unordered lists, blockquotes, horizontal rules.
 * Shared by the public blog (server) and the editor preview (client island).
 */
