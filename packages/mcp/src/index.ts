...
- posts.publish, posts.archive, assets.delete, posts.versions.restore, and posts.update on a published post mutate live state. Explain the intended effect and get explicit approval immediately before the call. Draft-only create/update and read-only tools do not require approval.
