...
- Public output is pinned to publishedVersionNumber until posts.publish moves the pin. posts.update and posts.versions.restore require expectedVersionNumber and only change the private tip. posts.unarchive restores an archived post to draft. posts.publish, posts.archive, and assets.delete mutate live state — explain the intended effect and get explicit approval immediately before the call. Draft-only create/update and read-only tools do not require approval.
