...
export const RENDER_WARNING = {
  ...
  NESTING_LIMIT: "nesting-limit",
  PACKAGE_INSTALL_LIMIT: "package-install-limit",
...
const WARNING_PREFIXES: readonly (readonly [string, RenderWarningCode])[] = [
  ...
  ["Content nesting exceeds", RENDER_WARNING.NESTING_LIMIT],
  ["Package install block exceeds", RENDER_WARNING.PACKAGE_INSTALL_LIMIT],
